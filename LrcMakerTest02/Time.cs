...
namespace LrcMakerTest02
{
    internal struct Time
    {
        ...
        public int Seconds
        {
            get { return (int) ((time - 60 * Minutes)); }
        }
        ...
        {
            get { return (int) Math.Round(1000 * (time - Math.Floor(time))); }
        }
        ...
        {
            get { return (int) (1000 * Math.Round((double) Milliseconds / 1000, 2)); }
        }
        ...
        public string Info
        {
            get { return string.Format("{0:00}:{1:00}.{2:000}", Minutes, Seconds, Milliseconds); }
        }
        ...
        {
            get { return string.Format("{0:00}:{1:00}.{2:000}", Minutes, Seconds, ApproxMilliseconds); }
        }
